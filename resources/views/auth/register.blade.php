...
@section('contenido')
        <div class="col-md-6 offset-md-3">
            <div class="card ">
                <div class="card-header bg-color-11 text-dark h3 text-center">Registrarse</div>
                ...
                <div class="card-body">
                    <form method="POST" action="{{ route('register') }}">
                        ...
                        <div class="form-group row">
                            <label for="name" class="col-md-12 col-form-label text-md-left">Nombre de usuario</label>
